...
<body>
    ...
    <form method="POST" action="view_doctors1.php">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>
                        <a href='view_doctors1.php?delete_id=" . $row['id'] . "' onclick=\"return confirm('Are you sure you want to delete this doctor?');\">Delete</a>
                    </td>
                  </tr>";
        }
        echo "</table>";
